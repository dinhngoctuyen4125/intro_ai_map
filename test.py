...
try:
    G = ox.load_graphml("./templates/lang_thuong.graphml") # Lấy data từ file lang_thuong
except:
    G = ox.graph_from_place(place_name, network_type="all") # Nếu không load được => lấy file trên mạng
    ox.save_graphml(G, filepath="./templates/lang_thuong.graphml")
